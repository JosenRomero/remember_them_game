    ...
    <Modal isOpen={isOpenModal} closeModal={clear} title={ t('text.editAnswer') }>
      <div className="mt-5">
        <input 
          ...
          className="bg-white border text-gray-700 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 rounded py-2 px-3 w-3/4 shadow"
        />
      </div>
